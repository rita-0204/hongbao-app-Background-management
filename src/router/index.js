...
const mainRoutes = {
  ...
  children: [
    ...
    // { path: '/viedoEdit', component: _import('modules/operate/viedolist-edit5'), name: 'viedoEdit'},
    // { path: '/viedoList', component: _import('modules/operate/viedolist'), name: 'viedoList'}
  ],
