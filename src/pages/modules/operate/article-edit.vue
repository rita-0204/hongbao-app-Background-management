  ...
  <el-dialog
    ...
    :visible.sync="visible" class="articleDialog">
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm"
        ...
        <el-form-item label="用户ID" prop="userid" :class="{ 'is-required': !dataForm.id }">
        ...
        <el-form-item label="详情" prop="detail">
          <AddOrUpdate v-on:childByValue="childByValue" v-bind:content="content"></AddOrUpdate>
        </el-form-item>
        </el-form>
...
//        downImg: '#',
    ...
    methods: {
      init(id,channel) {
        ...
        //  编辑
        this.$http({
          url: this.$http.adornUrl(`/mcn/get/news/editor/info`),
          method: 'post',
          ...
          if (data.resultCode == 0) {
            ...
            this.dataForm.userid = data.data.id
            this.option.img = data.data.cover
//            this.downImg = data.data.cover
            this.content = data.data.content
//            this.downImg = 'http://serverstatic.ertoutiao.com/manager/image/2018/11/27/1543301004349_back.png'
//            console.log(this.option.img,this.downImg)
          }
        })
      },
      //  上传图片
